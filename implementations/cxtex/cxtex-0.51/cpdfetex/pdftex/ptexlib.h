...
$Id: ptexlib.h,v 1.2 2004/05/11 14:30:32 taco Exp taco $
*/
...
typedef struct {
    ...
    internal_font_number firstfont;   /* first font that has accessed to this
...
typedef struct {
    ...
    internal_font_number tfm_num; /* number of first TFM using this entry */
...
extern internal_font_number tex_font;
...
/* utils.c */
extern boolean str_eq_cstr(str_number, char *);
...
extern void ff_putchar(eight_bits b);
...
extern void update_enc(internal_font_number, char **);
...
/* writet3.c */
extern void writet3(int, internal_font_number);
