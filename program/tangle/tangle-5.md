...
For example, after reading about 2250 lines of `tex.web`, these are the contents of the `byte_mem` and `byte_start` arrays (TODO: turn them into pretty diagrams, maybe even interactive ones):
